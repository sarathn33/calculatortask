...
description.textContent = 'DOM calulator';
...
var btndoubzero = document.createElement('button');
btndoubzero.setAttribute('onclick', 'numeric("00")');
btndoubzero.textContent="00";
  ...
  number.append(btnsub,btnone,btntwo,btnthree,btnadd,btnzero,btndoubzero,btndot,btnequal)
